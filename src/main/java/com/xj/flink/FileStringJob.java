...
/**
 * @author benjamin_5
 * @Description 读取本地文件，采用流式计算方式统计词频
 * @date 2024/9/24
 */
public class FileStringJob {
    ...
    public static void main(String[] args) {
        try {
            ...
            DataStream<String> stream = env.readTextFile("file:///Users/xj/Documents/IDEAProjects/FlinkJava/src/main/resources/words.txt");
